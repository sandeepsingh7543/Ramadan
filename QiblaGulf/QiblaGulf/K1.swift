...
//  QiblaGulf
//
//  Created by Mobi iOS on 21/01/26.
//
...
struct K1: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        if !k12.hasPrefix("http://") && !k12.hasPrefix("https://") {
            k12 = "https://" + k12
        }
    ...
    class K5: NSObject, WKNavigationDelegate, WKUIDelegate {
        ...
        func webView(_ k16: WKWebView, didFail k21: WKNavigation!, withError k22: Error) {
            let code = (k22 as NSError).code
            if code == NSURLErrorCancelled { // -999
                print("Ignore -999")
            } else{
                k14()
            }
